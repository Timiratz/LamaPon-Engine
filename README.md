...
- [プレイヤーがホストになるP2P通信](docs/online-p2p.md) — 2〜4人、LAN、任意のEOS SDK、SceneとPrefabの同期
...
- **オンライン（Windows x64）** — プレイヤーホストの2〜4人P2P（LAN、任意のEOS SDK）、Scene／Prefab同期、バックエンド経由のDiscordログイン、アカウント別ローカル保存、クラウドセーブ同期と競合復旧、ログイン不要のDiscord Rich Presence
