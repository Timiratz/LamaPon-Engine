...
ゲーム制作が初めての人向けに、C++を理解し、実際にゲームを作りながら、ゲームエンジニアとして成長するための最初の一歩を案内します。所要時間は30〜60分です。
...
3. テンプレートは「３D学習」または「２D学習」を選び、「作成して開く」を押します。
...
このエンジンが目指す軸は、ゲームエンジニアを育てること、C++を理解すること、実際にゲームを作ること、ゲームエンジンのサポートを充実させることです。詳しい道筋は[学習ロードマップ](learning-path.md)にあります。
...
- 「ファイル」→「プロジェクト設定...」で起動Scene、解像度、品質、入力、タグ、ゲームアイコンを設定できます。
- 「ファイル」→「ゲームをエクスポート...」で配布フォルダーを作れます。「配布用ZIPも作成」を選べば友達へ渡せるZIPも生成されます。
