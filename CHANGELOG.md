...
- Windows x64へ2〜4人のホスト主導P2P通信を追加。Epic不要のDirect方式で数値IPv4 / IPv6へ接続し、共有キー認証、ECDH-P256 / HKDF-SHA256 / AES-256-GCMによる暗号化に対応。専用ゲームサーバー・アカウント・SDKは不要。別回線ではホストへ到達できる公開接続先とポート転送、またはIPv6が必要。
