...
namespace LamaPon
{
    ...
    EditorLayer::RenderTexturePickerResult
    ...
    void EditorLayer::DrawInspector()
    {
        ...
        for (auto& component : selected->Components())
        {
                    ...
                    component.get()))
            {
                ...
                dynamic_cast<UIToggleComponent*>(
                    component.get()))
            {
                ...
                dynamic_cast<UISliderComponent*>(
                    component.get()))
            {
                float minimumValue =
                    slider->MinimumValue();
            ...
            else if (auto* scrollView =
                dynamic_cast<UIScrollViewComponent*>(
                    component.get()))
            {
                ImGui::TextDisabled(
                    "コンテンツ高さ: %.0f / スクロール: %.0f",
