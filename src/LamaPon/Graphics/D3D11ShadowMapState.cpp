...
namespace LamaPon::Detail
{
    ID3D11ShaderResourceView*
        D3D11ShadowMapState::ShaderResourceView() const noexcept
    {
        return m_shaderResourceView.Get();
    }

    void D3D11ShadowMapState::Initialize(
        ...
        const bool cube)
    {
        ...
        if (resolution > D3D11_REQ_TEXTURE2D_U_OR_V_DIMENSION)
        {
            throw std::invalid_argument(
                "ShadowMap resolution exceeds the DirectX 11 limit.");
        }
        ...
        textureDescription.ArraySize = m_cascadeCount;
    ...
    void D3D11ShadowMapState::Begin(
