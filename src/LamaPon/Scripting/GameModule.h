...
namespace LamaPon
{
    ...
    // API 24では影マップの資源作成と描画先操作をGraphicsBackendの
    // 公開virtual契約へ追加し、ShadowMapのDevice / Context直呼びAPIを
    // 内部化したため、ゲーム用DLLの再ビルドが必要です。
    inline constexpr std::uint32_t GameModuleApiVersion = 24;
