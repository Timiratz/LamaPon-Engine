...
#ifdef __MINGW32__
__CRT_UUID_DECL(AudioVolumeMeter,       0x4FC3B166, 0x972A, 0x40CF, 0xBC, 0x37, 0x7D, 0xB0, 0x3D, 0xB2, 0xFB, 0xA3);
__CRT_UUID_DECL(AudioReverb,            0xC2633B16, 0x471B, 0x4498, 0xB8, 0xC5, 0x4F, 0x09, 0x59, 0xE2, 0xEC, 0x09);
#endif
